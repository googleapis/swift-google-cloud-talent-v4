  ...
  Sendable
{
  ...
  /// [google.cloud.talent.v4.Job.requisition_id]: <doc:Job/requisitionId>
  /// [google.cloud.talent.v4.JobService.DeleteJob]: <doc:JobService/deleteJob(request:)>
  /// [google.cloud.talent.v4.JobService.GetJob]: <doc:JobService/getJob(request:)>
  /// [google.cloud.talent.v4.JobService.ListJobs]: <doc:JobService/listJobs(request:)>
  /// [google.cloud.talent.v4.JobService.UpdateJob]: <doc:JobService/updateJob(request:)>
