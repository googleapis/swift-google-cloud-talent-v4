...
extension Clients {
  final class EventServiceRetry: EventServiceStub {
    let inner: any EventServiceStub
    let options: GoogleCloudGax.ClientOptions

    public init(_ inner: any EventServiceStub, options: GoogleCloudGax.ClientOptions) {
      self.inner = inner
    ...
    public func createClientEvent(
      ...
      try await self._intercept(
        ...
        idempotent: false,
        action: {
          (r: CreateClientEventRequest, o: GoogleCloudGax.RequestOptions) async throws
            -> GoogleCloudTalentV4.ClientEvent
          in
          return try await self.inner.createClientEvent(request: r, options: o)
        })
    }
